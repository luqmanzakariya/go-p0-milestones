    ...
    <div class="hidden md:flex md:items-center md:w-auto w-full" id="menu">
      <nav>
        <ul
          ...
          <li>
            <a class="md:p-4 py-3 px-0 block" href="admin.php">Message</a>
          </li>
          <li>
            <a class="md:p-4 py-3 px-0 block" href="resetPasswordAdmin.php#product">Reset Password</a>
          </li>
          <li>
      ...
      <div class="flex flex-col">
        <div class=" overflow-x-auto">
          <div class="overflow-hidden ">
            <table class="rounded-xl table-auto m-[30px]">
              <thead>
                <tr class="bg-gray-50">
