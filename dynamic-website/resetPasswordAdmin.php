...
<body>
  ...
  <section>
    ...
    <div
      ...
      <form class="flex w-[30rem] flex-col space-y-10" action="resetPasswordAdmin.php" method="post">
        <div class="text-center text-4xl font-medium">Reset Password Admin</div>
